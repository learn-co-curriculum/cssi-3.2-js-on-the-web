...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/cssi-3.2-js-on-the-web' title='JavaScript on the Web'>JavaScript on the Web</a> on Learn.co and start learning to code for free.</p>
